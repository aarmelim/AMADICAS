...
<head>
	...
	<!-- Meta Description -->
	<meta name="description" content="Dicas de livros que tenho lido ao longo dos últimos anos, detalhes de livros, downloads de livros, resenhas de livros, sugestão de livros para leitura">
	<!-- Meta Keyword -->
		...
		<div class="working-process-area">
			<div class="container">
				...
				<ul class="list-unstyled">
					...
					<li class="media">
						<img class="align-self-center border border-dark rounded img-fluid mr-3" src="../_img/livros/<?php echo $linha["imagem_grande"] ?>" alt="Imagem de dica de livro - <?php echo $linha["imagem_grande"] ?>">
			...
			<div class="container">
				<div class="list-group">
					<a href="livros_detalhe.php" class="list-group-item list-group-item-action flex-column align-items-start active">
						...
						<img class="align-self-center mr-3" src="_img/livros/VIDAS_SECAS_pequena.jpg" alt="VIDAS_SECAS_pequena.jpg">
				...
				<section class="about-generic-area">
					<div class="container border-top-generic">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="img-text">
									<img src="_img/livros/VIDAS_SECAS_pequena.jpg" alt="" class="img-fluid float-left mr-20 mb-20">
