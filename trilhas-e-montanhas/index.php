...
<head>
	...
	<!-- Meta Description -->
	<meta name="description" content="Dicas de trilhas e montanhas que fiz ao longo dos últimos anos, trilhas e montanhas, sugestão de trilhas, sugestão de expedição e trilhas por montanhas">
	<!-- Meta Keyword -->
				...
				<div class="row justify-content-center generic-height align-items-center">
					<div class="col-lg-8">
						<div class="banner-content text-center">
							<h1 class="text-white text-uppercase mb-10">Dicas de trilhas e montanhas</h1>
							<p class="text-white">Trilhas e Montanhas para as quais fui ao longo dos últimos anos. Espero que gostem.</p>
