...
<head>
	...
	<!-- Meta Description -->
	<meta name="description" content="Dicas de filmes que vi ao longo dos últimos anos, filmes, downloads de filmes, sugestão de filmes, sugestão de documentários">
	<!-- Meta Keyword -->
				...
				<div class="row justify-content-center generic-height align-items-center">
					<div class="col-lg-8">
						<div class="banner-content text-center">
							<h1 class="text-white text-uppercase mb-10">Dicas de Filmes, Séries e Documentários</h1>
							<p class="text-white">Filmes, Séries e Documentários que vi ao longo dos últimos anos. Espero que gostem.</p>
